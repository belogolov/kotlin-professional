...
open class Rectangle(
    ...
    override fun diffArea(f: Figure): Int = abs(area() - f.area())
...
class Square(i: Int) : Rectangle(i, i)
...
class HomeWork2Test {
    ...
    fun diffAreaTest() {
        ...
        assertEquals(100, a.diffArea(b))
        assertEquals(0, a.diffArea(a))
    }

    private fun diffArea(a: Figure, b: Figure): Int = abs(a.area() - b.area())
